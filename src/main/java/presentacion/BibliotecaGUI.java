    ...
    btnAceptar.addActionListener(e -> {
        try {
            ...
            if (comboTipo.getSelectedItem().equals("Lector")) {
                ...
                logica.clases.Lector lector = new logica.clases.Lector();
                ...
                logica.manejadores.UsuarioHandler.getInstancia().agregarLector(lector);
                JOptionPane.showMessageDialog(frame, "Lector registrado correctamente.");
            } else {
                String numEmp = txtNumEmp.getText();
                logica.clases.Bibliotecario biblio = new logica.clases.Bibliotecario();
                biblio.setNombre(nombre);
                biblio.setCorreo(correo);
                biblio.setIdEmp(Integer.parseInt(numEmp));
                logica.manejadores.UsuarioHandler.getInstancia().agregarBibliotecario(biblio);
